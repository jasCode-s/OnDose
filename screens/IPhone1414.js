...
Decreased appetite`}</Text>
      ...
      <View style={[styles.iphone1414Item, styles.iphone1414Position]} />
      <View style={[styles.iphone1414Inner, styles.iphone1414Position]} />
      <View style={styles.rectangleContainer}>
        ...
        />
        <Image
          style={[styles.groupChildPosition, styles.childLayout1]}
          resizeMode="cover"
        ...
        <View style={[styles.reminderParent, styles.settingsPosition]}>
          ...
          <View style={styles.vectorContainer}>
            <Pressable
              style={[styles.vector3, styles.vectorIconPosition2]}
