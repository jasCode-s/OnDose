  ...
  return (
    <View style={styles.iphone1416}>
      ...
      <View style={styles.iphone142}>
        <View style={[styles.vectorParent, styles.groupChild1Layout]}>
          <Image
          ...
          />
          <Image
            style={[styles.vectorIcon2, styles.iconPosition, styles.iconLayout]}
            resizeMode="cover"
        ...
        />
        <View style={styles.iphoneScreenDefault1}>
          <Image
          ...
          />
          <Image
            style={[styles.iconSignal1, styles.vectorIconPosition]}
            resizeMode="cover"
            source={require("../assets/-icon-signal1.png")}
          />
        </View>
        <View style={[styles.rectangleGroup, styles.dosagesPosition]}>
          <View style={[styles.frameChild, styles.groupInnerLayout]} />
          <View
            style={[
              styles.frameItem,
...
Decreased appetite`}</Text>
      ...
      <View style={[styles.iphone1416Child, styles.iphone1416Position]} />
      <View style={[styles.iphone1416Item, styles.iphone1416Position]} />
      <View style={styles.rectangleParent1}>
        ...
        />
        <Image
          style={[styles.groupPosition, styles.groupChildLayout]}
          resizeMode="cover"
        ...
        <View style={[styles.reminderParent, styles.settingsPosition]}>
          ...
          >
            <Image
              style={[styles.iconCog, styles.iconPosition, styles.iconLayout]}
              resizeMode="cover"
          ...
          <View style={styles.vectorGroup}>
            <Pressable
              style={[styles.vector4, styles.iconPosition]}
