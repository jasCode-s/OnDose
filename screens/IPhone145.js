  ...
  return (
    <View style={styles.iphone145}>
      ...
      <View style={[styles.medB, styles.medLayout, styles.medPosition]}>
        <View
          style={[styles.iconImage, styles.medLayout, styles.iconImagePosition]}
        >
          <View
            style={[
              styles.iconImage,
              styles.medLayout,
              styles.iconImagePosition,
            ]}
          >
            <View
              style={[
        ...
        <View style={[styles.medicationParentPosition, styles.take1PillLayout]}>
          <Text
      ...
      <View style={[styles.medC, styles.medLayout, styles.medPosition]}>
        <View
          style={[styles.iconImage, styles.medLayout, styles.iconImagePosition]}
        >
          <View
        ...
        <View
          style={[styles.take1Pill1Layout, styles.medicationParentPosition]}
        >
          <Text
            style={styles.medicationB}
          >
      ...
      <View style={styles.iphone142}>
        ...
        <View style={[styles.rectangleContainer, styles.dosagesPosition]}>
          ...
          />
          <Image
            style={[styles.iconImage2, styles.iconLayout]}
            resizeMode="cover"
            source={require("../assets/-icon-image.png")}
          />
          <View style={[styles.medicationAParent, styles.medicationLayout]}>
            <Text
              style={styles.medicationB}
            >
              Medication A
...
Decreased appetite`}</Text>
      ...
      <View style={[styles.medB1, styles.medLayout, styles.medPosition]}>
        ...
        >
          ...
          <View style={styles.medicationParentPosition}>
            <Text
              style={styles.medicationB}
            >
              Medication B
            ...
            <Text
              style={[styles.take1Typo, styles.leftClr, styles.take1Position]}
            >{`Take 1 Pill / Time, 2 Times Left `}</Text>
          </View>
        </View>
        <Pressable
          style={styles.vector1}
          onPress={() => navigation.navigate("IPhone1450")}
        >
          <Image
            style={styles.iconLayout1}
            resizeMode="cover"
      ...
      <View style={[styles.iphone145Item, styles.iphone145Position]} />
      <View style={[styles.iphone145Inner, styles.iphone145Position]} />
      <View style={styles.rectangleParent1}>
        ...
        <View style={[styles.reminderParent, styles.settingsPosition]}>
          ...
          <View style={styles.vectorContainer}>
            <Pressable
              style={[styles.vector5, styles.vectorIconPosition2]}
